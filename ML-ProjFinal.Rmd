...
pml.training <- read.csv("D:\\ACHU\\NITK\\Online courses\\R\\Machine Learning\\pml-training.csv")
...
proc.time() - ptm
```
To capture the execution time I've used `ptm` and `proc.time()`. Time taken ~ 18 minutes
```{r}
print(modFit)
...
```{r}
pml.testing <- read.csv("D:\\ACHU\\NITK\\Online courses\\R\\Machine Learning\\pml-testing.csv")
